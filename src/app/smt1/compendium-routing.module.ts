...
import { NesFissionTableComponent } from './components/nes-fission-table.component';
import { NesFusionTableComponent } from './components/nes-fusion-table.component';
import { NesTripleFissionTableComponent } from './components/nes-tri-fission-table.component';
import { NesTripleFusionTableComponent } from './components/nes-tri-fusion-table.component';
        ...
        children: [
          {
            ...
            component: NesTripleFissionTableComponent
          },
          {
            path: 'fusions/triple',
            component: NesTripleFusionTableComponent
          },
          {
            path: 'fissions',
            component: NesFissionTableComponent
          },
          {
            path: 'fusions',
            component: NesFusionTableComponent
          },
          {
            path: '**',
            redirectTo: 'fissions',
